...
/**
 * Contrôleur pour les notifications email
 */
class EmailController {
   ...
   */
  async sendWeeklyHealthReport(req, res) {
    try {
      ...
      const weeklyData = await this.getWeeklyHealthData(userId, startDate, endDate);
   ...
   */
  async sendGarminConnectionEmail(req, res) {
    try {
      const { userEmail, userName } = req.body;
   ...
   */
  async sendGoalAchievementEmail(req, res) {
    try {
   ...
   */
  async scheduleWeeklyReports(req, res) {
    try {
      ...
      for (const user of activeUsers) {
        try {
          ...
          const weeklyData = await this.getWeeklyHealthData(user._id, startDate, endDate);
   ...
   */
  async getWeeklyHealthData(userId, startDate, endDate) {
    try {
